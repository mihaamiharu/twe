...
**The Problem**: If _anything_ changes in the structure (e.g., a wrapper div is added), this path breaks.
...
**The Problem**: Starting with `//*` forces the browser to scan _every single element_ in the DOM. On large pages, this is slow.

...
function TutorialsManager() {
    ...
    const updateMutation = useMutation({
        ...
        onSuccess: () => {
            void queryClient.invalidateQueries({ queryKey: ['admin-tutorials'] });
    ...
    if (isLoading) return <div className="p-8 text-center animate-pulse motion-reduce:animate-none">Loading tutorials...</div>;

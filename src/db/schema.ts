...
// ============================================================================
// PRIVATE COURSE REVIEW WORKSPACE
// ============================================================================
...
export const courseReviews = pgTable(
  'course_reviews',
  {
    ...
    status: courseReviewStatusEnum('status').notNull().default('DRAFT'),
    checkpointDrafts: jsonb('checkpoint_drafts')
      .$type<CourseReviewDraftMap>()
      .notNull(),
  ...
  (table) => ({
    reviewerIdx: index('idx_course_reviews_reviewer_id').on(table.reviewerId),
    repositoryIdx: index('idx_course_reviews_repository_url').on(
      table.repositoryUrl,
    ),
  }),
);

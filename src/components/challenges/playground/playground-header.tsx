      ...
      <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
        <div className="min-w-0">
          ...
          <div className="flex items-center gap-1.5 md:gap-2 text-[10px] md:text-xs text-muted-foreground mt-0.5 md:mt-1 flex-wrap">
            ...
            <ChallengeStateIndicator
              state={challenge.isCompleted ? 'completed' : 'available'}
            />
            <Badge
              variant="outline"
      ...
      <div className="flex items-center gap-1.5 md:gap-3 flex-shrink-0">
        ...
        {isMobile && isCodeChallenge && (
          <Button
            ...
            onClick={onRunCode}
            disabled={isRunning}
            className="min-h-11 min-w-11 border-brand-teal font-bold text-brand-teal-dark hover:bg-brand-teal/10"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="h-11 border border-border/50 px-2 font-bold text-muted-foreground hover:text-foreground md:h-9 md:px-3"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                disabled={!hasPassed}
                className={cn(
                  'h-11 border border-border px-2 font-bold transition-all md:h-9 md:px-3',
                  hasPassed

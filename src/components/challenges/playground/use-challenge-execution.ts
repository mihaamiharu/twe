        ...
        try {
            ...
            if (
                ...
                if (assertionCount === 0) {
                    ...
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- dynamic values from sandbox execution context -- dynamic values from sandbox execution context, @typescript-eslint/no-unsafe-call -- dynamic values from sandbox execution context
                ...
                if (
                    ...
                    validationPassed = false;
                    // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment -- dynamic values from sandbox execution context -- dynamic values from sandbox execution context
                    outputMessage =
                        actual === undefined

...
export function PlaygroundGoalBar({ description }: PlaygroundGoalBarProps) {
    ...
    return (
        <div className="bg-primary/5 border-b border-border px-3 md:px-4 py-1.5 md:py-2 shrink-0">
            <div className="flex items-start gap-2 md:gap-3">
                <div className="bg-primary/10 p-1 rounded-md shrink-0 border border-primary/25 mt-0.5">
                ...
                <p className="text-xs md:text-sm font-bold text-foreground/90 leading-snug">
                    <span className="text-primary mr-1 md:mr-2">

...
export type ChallengeFilterStatus =
  | 'all'
  | 'available'
  | 'completed'
  | 'locked';
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center">
          <Select
            value={status}
            onValueChange={(value) =>
              onStatusChange(value as ChallengeFilterStatus)
            }
          >
            <SelectTrigger
              className="h-11 w-full min-w-0 bg-background sm:w-[140px]"
          ...
          <Select
            value={difficulty}
            onValueChange={(value) =>
              onDifficultyChange(value as ChallengeFilterDifficulty)
            }
          >
            <SelectTrigger
              className="h-11 w-full min-w-0 bg-background sm:w-[150px]"

...
export function ChallengeTierProgress({ progress, selectedTier, onSelectTier }: ChallengeTierProgressProps) {
    return (
                ...
                return (
                    ...
                    >
                        <div className="flex items-center justify-between">
                            <span className={cn("text-sm font-bold", item.color)}>{item.name}</span>
                            <Badge variant="secondary" className="text-[10px] font-mono bg-background/50">

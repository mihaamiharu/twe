...
export function FileExplorer({
        ...
        <div
          className={cn(
            ...
            isSelected
              ...
              : 'hover:bg-workspace-elevated text-workspace-muted',
          )}
        ...
        >
          ...
          <span
            className={cn(
              ...
              isSelected ? 'font-bold text-workspace-text' : '',
            )}
            title={node.name}
          >
            {node.name}
  ...
  return (
    <div
      className={cn(
        'technical-surface flex flex-col h-full bg-workspace-panel border-r border-workspace-border',
        className,
      )}
    >
      <div className="p-3 border-b border-workspace-border bg-workspace-background">
        <h3 className="text-[10px] font-bold uppercase tracking-wider text-workspace-muted">
          Explorer
        </h3>
      </div>

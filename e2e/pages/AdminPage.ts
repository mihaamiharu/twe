...
export class AdminPage extends BasePage {
    ...
    constructor(page: Page) {
        super(page);
        this.dashboardTitle = page.locator('h1').filter({ hasText: /admin dashboard|dashboard admin/i });
        ...
        this.userModerationLink = page.getByRole('link', { name: /user moderation/i });
        this.challengeManagerLink = page.getByRole('link', { name: /challenge manager/i });
    }

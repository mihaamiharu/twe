...
* *Examples: Bug, Deploy, Automation Script, Repository, Branch, Merge Request, Environment, Framework, Assertion, Locator, Flaky, Edge Case.*
...
* *Example: "Buka menu **Settings** lalu klik **Run Test**."*

* **Tier 3: Technical Verbs (Indonesianized or Active)**
* *Examples: Eksekusi (Execute), Inisialisasi (Initialize), Konfigurasi (Configure), Verifikasi (Verify).*
...
* *English:* "You might want to check the logs if it fails."
* *Natural Tech ID:* "Cek log jika proses gagal." (More direct and efficient).
...
| "Ensure the element is clickable." | "Pastikan elemen bisa diklik." | "**Verifikasi** bahwa elemen tersebut sudah *interactable* (bisa diklik)." |
| "Catching bugs early in the CI." | "Menangkap bug awal di CI." | "Mendeteksi **bug** lebih dini pada *pipeline* CI." |
...
* [ ] **Tool Accuracy:** Are specific tool terms (e.g., *Cypress commands, Selenium locators*) intact?

// @ts-expect-error -- dist import is generated by the production build and has no source type declaration
...
Bun.serve({
    ...
    async fetch(req) {
        ...
        try {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access -- production SSR bundle exposes the runtime fetch adapter dynamically
